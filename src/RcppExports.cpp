...
#include "../inst/include/rangernew.h"
#include <Rcpp.h>

using namespace Rcpp;

// rangernewCpp
Rcpp::List rangernewCpp(uint treetype, std::string dependent_variable_name, Rcpp::NumericMatrix input_data, std::vector<std::string> variable_names, uint mtry, uint num_trees, bool verbose, uint seed, uint num_threads, bool write_forest, uint importance_mode_r, uint min_node_size, std::vector<std::vector<double>>& split_select_weights, bool use_split_select_weights, std::vector<std::string>& always_split_variable_names, bool use_always_split_variable_names, std::string status_variable_name, bool prediction_mode, Rcpp::List loaded_forest, Rcpp::RawMatrix sparse_data, bool sample_with_replacement, bool probability, std::vector<std::string>& unordered_variable_names, bool use_unordered_variable_names, bool save_memory, uint splitrule_r, std::vector<double>& case_weights, bool use_case_weights, bool predict_all, bool keep_inbag, double sample_fraction, double alpha, double minprop, bool holdout, uint prediction_type_r);
RcppExport SEXP rangernew_rangernewCpp(SEXP treetypeSEXP, SEXP dependent_variable_nameSEXP, SEXP input_dataSEXP, SEXP variable_namesSEXP, SEXP mtrySEXP, SEXP num_treesSEXP, SEXP verboseSEXP, SEXP seedSEXP, SEXP num_threadsSEXP, SEXP write_forestSEXP, SEXP importance_mode_rSEXP, SEXP min_node_sizeSEXP, SEXP split_select_weightsSEXP, SEXP use_split_select_weightsSEXP, SEXP always_split_variable_namesSEXP, SEXP use_always_split_variable_namesSEXP, SEXP status_variable_nameSEXP, SEXP prediction_modeSEXP, SEXP loaded_forestSEXP, SEXP sparse_dataSEXP, SEXP sample_with_replacementSEXP, SEXP probabilitySEXP, SEXP unordered_variable_namesSEXP, SEXP use_unordered_variable_namesSEXP, SEXP save_memorySEXP, SEXP splitrule_rSEXP, SEXP case_weightsSEXP, SEXP use_case_weightsSEXP, SEXP predict_allSEXP, SEXP keep_inbagSEXP, SEXP sample_fractionSEXP, SEXP alphaSEXP, SEXP minpropSEXP, SEXP holdoutSEXP, SEXP prediction_type_rSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(rangernewCpp(treetype, dependent_variable_name, input_data, variable_names, mtry, num_trees, verbose, seed, num_threads, write_forest, importance_mode_r, min_node_size, split_select_weights, use_split_select_weights, always_split_variable_names, use_always_split_variable_names, status_variable_name, prediction_mode, loaded_forest, sparse_data, sample_with_replacement, probability, unordered_variable_names, use_unordered_variable_names, save_memory, splitrule_r, case_weights, use_case_weights, predict_all, keep_inbag, sample_fraction, alpha, minprop, holdout, prediction_type_r));
    return rcpp_result_gen;
END_RCPP
}
// KMestimateWeight
Rcpp::NumericVector KMestimateWeight(Rcpp::NumericVector Xobserved, Rcpp::NumericVector delta);
RcppExport SEXP rangernew_KMestimateWeight(SEXP XobservedSEXP, SEXP deltaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type Xobserved(XobservedSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type delta(deltaSEXP);
    rcpp_result_gen = Rcpp::wrap(KMestimateWeight(Xobserved, delta));
    return rcpp_result_gen;
END_RCPP
}
// rsqcomp
double rsqcomp(Rcpp::NumericVector scalar_ypre, Rcpp::NumericVector scalar_w, Rcpp::NumericVector scalar_y);
RcppExport SEXP rangernew_rsqcomp(SEXP scalar_ypreSEXP, SEXP scalar_wSEXP, SEXP scalar_ySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type scalar_ypre(scalar_ypreSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type scalar_w(scalar_wSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type scalar_y(scalar_ySEXP);
    rcpp_result_gen = Rcpp::wrap(rsqcomp(scalar_ypre, scalar_w, scalar_y));
    return rcpp_result_gen;
END_RCPP
}
