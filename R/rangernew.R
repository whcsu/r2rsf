...
##' @import utils
##' @export
rangernew <- function(formula = NULL, data = NULL, num.trees = 500, mtry = NULL,
  ...
  if (is.null(splitrule)) {
    ...
    if (treetype == 5 ) {
      ...
      stop("Error: r2 splitrule applicable to  survival data only.")
    }
  }else {
  ...
  if (write.forest) {
    ...
    class(result$forest) <- "rangernew.forest"
